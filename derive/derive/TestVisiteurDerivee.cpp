...
Cette hiérarchie est munie des fonctionnalités : évaluer et conversion en string

Elle est munie d'un visiteur qui permet d'ajouter d'autres fonctionnalités. 
Ce visiteur permet d'ajouter le calcul de dérivée
